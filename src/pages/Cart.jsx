  ...
  const applyCoupon = () => {
    const coupons = {
      ...
      URVISH016: {
        type: 'percentage',
        value: 25,
        description: '25% special discount'
      }
    };
    ...
    if (coupon) {
      ...
      if (coupon.type === 'percentage') {
        discount = getSubtotal() * (coupon.value / 100);
      } else {
        discount = Math.min(coupon.value, getSubtotal());
      }
          ...
          <div className="order-summary-section">
            ...
            <div className="order-summary">
              ...
              <div className="summary-details">
                ...
                <button
                  type="button"
                  className="bill-details-link"
                  onClick={() =>
                    alert('Bill details are shown below.')
                  }
                >
                  Bill Details
                </button>
